...
var EtsyDetailView = Backbone.View.extend ({
	...
	_render: function (){
		...
		var img = objListing.Images[0].url_fullxfull
				htmlString += '<div id="listingContainer"><div id="bigImg"><img src="' + img +'" id="listingImage">'
				htmlString += '</div><div id="listingDescription"><h1 id="title">'+ objListing.title +'</h1>'
				htmlString += '<h1 id="shop"> By: ' + objListing.Shop.shop_name +'</h1>'+'<h1 id="description">'+ objListing.description +'</h1>'
				htmlString += '<h1 id="money">'+ objListing.price + ' ' + objListing.currency_code +'</h1>'
				htmlString += '<h1 id="quantity" > Quantity:'+ objListing.quantity +'</h1></div>'
